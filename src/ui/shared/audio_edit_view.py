...
class AudioEditView:
    ...
    def render(self) -> None:
        ...
        button_disabled = speed_rate == cache.speed_rate and \
            pitch_steps == cache.pitch_steps and \
            noise_amount == cache.noise_amount
        ...
        if st.button("Apply edits", disabled=button_disabled):
            with st.spinner("Processing audio..."):
                ...
                cache.audio_bytes = AudioHelper.samples_to_bytes(processed_y, sr=self._sr)
